...
//    GpioCtrlRegs.GPBMUX2.bit.GPIO53 = 1;   // Configure GPIO53 as EQEP1I
    ...
    EQep1Regs.QPOSMAX=0xFFFFFF;
    EQep1Regs.QEPCTL.bit.QPEN=1; 		// QEP enable

    EQep1Regs.QCAPCTL.bit.UPPS=0;   	// 1/32 for unit position
    EQep1Regs.QCAPCTL.bit.CCPS=0;		// 1/128 for CAP clock
    EQep1Regs.QCAPCTL.bit.CEN=1; 		// QEP Capture Enable
    EQep1Regs.QPOSINIT = 0xFFFF;
    EQep1Regs.QPOSCNT = 0xFFFF;
}
...
// Comment out other unwanted lines.
    ...
    EQep2Regs.QPOSINIT = 0xFFFF;
    EQep2Regs.QPOSCNT = 0xFFFF;
}
#endif // endif DSP28_EQEP2
